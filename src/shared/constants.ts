...
export const SERVER_UPDATE_RATE: number = 8 // duration between each gamestate.update()
export const SERVER_TICK_RATE: number = 20 // duration between each packet send
...
export const VISIBLE_WIDTH: number = 1440
export const VISIBLE_HEIGHT: number = 810
...
// powerup
export const POWERUP_RATE: number = 0 //0.1 / 1000 // must be between 0 and 1 inclusive, expected number of powerups per ms
...
// ripple effects
export const RIPPLE_TRUE_WIDTH = 30 * 16 //400
export const RIPPLE_TRUE_HEIGHT = 30 * 9 //225
...
export const RIPPLE_PLAYER_SIZE = 0.010
